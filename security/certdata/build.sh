...
# This script builds the package certdata

echo "[*] Creating make-cert.pl"
...
# this expects ./certdata.txt, but it's already downloaded by cpkg itself.
echo "[*] Running make-ca.sh"
make-ca.sh
...
rm -r certdata.txt certs BLFS-ca-bundle*
